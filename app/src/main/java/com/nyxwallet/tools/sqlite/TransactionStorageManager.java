package com.nyxwallet.tools.sqlite;


import android.content.Context;
import android.util.Log;

import com.nyxwallet.presenter.entities.BRTransactionEntity;
...
public class TransactionStorageManager {
    ...
    public static boolean putTransaction(Context app, String iso, BRTransactionEntity tx) {
        ...
        if (iso.equalsIgnoreCase("nyx") || iso.equalsIgnoreCase("btc") || iso.equalsIgnoreCase("bch")) {
