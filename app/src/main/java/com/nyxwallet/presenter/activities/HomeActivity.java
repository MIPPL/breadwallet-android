...
import com.nyxwallet.presenter.activities.settings.SecurityCenterActivity;
import com.nyxwallet.presenter.activities.settings.SettingsActivity;
...
import com.nyxwallet.tools.adapter.WalletListAdapter;
import com.nyxwallet.tools.animation.BRAnimator;
import com.nyxwallet.tools.animation.BRDialog;
import com.nyxwallet.tools.listeners.RecyclerItemClickListener;
...
import com.nyxwallet.tools.manager.PromptManager;
...
//                Log.d("HomeActivity", "Saving current wallet ISO as " + mAdapter.getItemAt(position).getIso(HomeActivity.this));
        ...
        mSupport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://discord.gg/Q465cD2"));
