...
import com.nyxwallet.presenter.activities.CurrencySettingsActivity;
import com.nyxwallet.presenter.activities.UpdatePinActivity;
import com.nyxwallet.presenter.activities.util.BRActivity;
import com.nyxwallet.presenter.entities.BRSettingsItem;
...
import static com.nyxwallet.R.layout.settings_list_item;
import static com.nyxwallet.R.layout.settings_list_section;
...
*/
        items.add(new BRSettingsItem(getString(R.string.Settings_coin), "", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SettingsActivity.this, CurrencySettingsActivity.class);
                BRSharedPrefs.putCurrentWalletIso(app, "NYX");//change the current wallet to the one they enter settings to
                startActivity(intent);
                overridePendingTransition(R.anim.enter_from_right, R.anim.exit_to_left);
            }
        }, false));
