...
import com.bitradiowallet.tools.util.BRDateUtil;
...
public class FragmentTxDetails extends DialogFragment {
    ...
    private void updateUi() {
        ...
        if (mTransaction != null) {
            ...
            mToFromAddress.setText(walletManager.decorateAddress(getActivity(), mTransaction.getToRecipient(walletManager, !sent))); //showing only the destination address
