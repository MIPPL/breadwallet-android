...
import static com.bitradiowallet.R.color.white;
import static com.bitradiowallet.tools.util.BRConstants.PLATFORM_ON;
import static com.bitradiowallet.tools.util.BRConstants.SCANNER_REQUEST;
...
//                            AuthManager.getInstance().authSuccess(LoginActivity.this);
        ...
        BitradioApp.addOnBackgroundedListener(new BitradioApp.OnAppBackgrounded() {
            @Override
