...
import com.bitradiowallet.tools.util.TrustedNode;
...
//    private TextView nodeLabel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final WalletBitradioManager wm = WalletBitradioManager.getInstance(NodesActivity.this);
    ...
    private void updateButtonText() {
        WalletBitradioManager wm = WalletBitradioManager.getInstance(this);
    ...
    private void createDialog() {
        ...
        mDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final WalletBitradioManager wm = WalletBitradioManager.getInstance(app);
