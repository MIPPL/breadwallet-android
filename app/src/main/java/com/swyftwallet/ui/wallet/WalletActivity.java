package com.swyftwallet.ui.wallet;
...
import com.swyftwallet.presenter.activities.HomeActivity;
import com.swyftwallet.presenter.activities.util.BRActivity;
import com.swyftwallet.presenter.customviews.BRButton;
import com.swyftwallet.presenter.customviews.BRNotificationBar;
import com.swyftwallet.presenter.customviews.BaseTextView;
import com.swyftwallet.presenter.entities.CryptoRequest;
import com.swyftwallet.presenter.fragments.FragmentSend;
...
import com.swyftwallet.tools.manager.FontManager;
...
import com.swyftwallet.tools.util.EventUtils;
import com.swyftwallet.tools.util.SyncTestLogger;
import com.swyftwallet.tools.util.TokenUtil;
import com.swyftwallet.tools.util.Utils;
import com.swyftwallet.ui.wallet.model.Balance;
import com.swyftwallet.ui.wallet.model.TxFilter;
import com.swyftwallet.ui.wallet.spark.SparkAdapter;
import com.swyftwallet.ui.wallet.spark.SparkView;
import com.swyftwallet.ui.wallet.spark.animation.LineSparkAnimator;
...
import com.swyftwallet.wallet.util.SyncUpdateHandler;
import com.swyftwallet.wallet.wallets.bitcoin.BaseBitcoinWalletManager;
...
public class WalletActivity extends BRActivity implements InternetManager.ConnectionReceiverListener, SyncListener,
    ...
    public static final String EXTRA_CRYPTO_REQUEST = "com.swyftwallet.ui.wallet.WalletActivity.EXTRA_CRYPTO_REQUEST";
    protected static final String EXTRA_CURRENCY_CODE = "com.swyftwallet.ui.wallet.WalletActivity.EXTRA_CURRENCY_CODE";
