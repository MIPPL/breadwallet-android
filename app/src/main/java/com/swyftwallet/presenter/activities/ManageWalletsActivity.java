...
import com.swyftwallet.tools.adapter.ManageTokenListAdapter;
import com.swyftwallet.tools.animation.SimpleItemTouchHelperCallback;
...
public class ManageWalletsActivity extends BaseSettingsActivity implements OnStartDragListener {
    ...
    protected void onResume() {
        ...
        for (int i = 0; i < mTokens.size(); i++) {
            ...
            } else if (tokenSymbol.equalsIgnoreCase(WalletBitcoinManager.BITCOIN_CURRENCY_CODE) || tokenSymbol.equalsIgnoreCase("BTC") )
