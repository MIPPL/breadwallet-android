...
This is the Android port of the breadwallet iOS app, which can be found [here](https://github.com/swyftwallet/breadwallet/).
...
4. Go to https://github.com/swyftwallet/breadwallet-android and clone or download the project
