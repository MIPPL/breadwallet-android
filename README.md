...
[![Get it on Google Play](/images/icon-google-play.png)](https://play.google.com/store/apps/details?id=swyftwallet)

### bitcoin done right

This is the Android port of the breadwallet iOS app, which can be found [here](https://github.com_swyftwallet_/breadwallet/).
...
4. Go to https://github.com_swyftwallet_/breadwallet-android and clone or download the project
